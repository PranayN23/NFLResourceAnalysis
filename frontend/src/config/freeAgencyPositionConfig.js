...
export const FA_VALUE_ANCHORS = {
  ...
  HB: [0.75, 1.5, 3.0, 6.0, 10.0, 14.0, 18.0, 22.0, 26.0, 30.0, 34.0, 38.0],
  WR: [0.75, 2.0, 5.0, 10.0, 15.0, 20.0, 28.0, 36.0, 42.0, 50.0, 56.0, 62.0],
  TE: [0.75, 1.5, 4.0, 8.0, 12.0, 16.0, 21.0, 26.0, 31.0, 36.0, 42.0, 48.0],
  T: [0.75, 2.0, 5.0, 10.0, 15.0, 22.0, 28.0, 35.0, 40.0, 46.0, 52.0, 58.0],
  G: [0.75, 1.5, 4.0, 8.0, 13.0, 18.0, 22.0, 27.0, 32.0, 36.0, 40.0, 45.0],
  C: [0.75, 1.5, 4.0, 8.0, 13.0, 18.0, 22.0, 27.0, 32.0, 36.0, 40.0, 45.0],
  ED: [0.75, 2.0, 4.0, 8.5, 13.5, 19.0, 26.0, 33.0, 37.0, 42.0, 46.0, 50.0],
  DI: [0.5, 1.5, 3.0, 6.0, 11.0, 16.0, 21.0, 26.0, 30.0, 34.0, 38.0, 42.0],
  LB: [0.75, 2.0, 4.0, 8.0, 13.0, 18.0, 23.0, 28.0, 32.0, 36.0, 40.0, 44.0],
  CB: [0.75, 2.0, 5.0, 10.0, 16.0, 22.0, 28.0, 34.0, 38.0, 43.0, 48.0, 53.0],
  S: [0.75, 1.5, 4.0, 8.0, 13.0, 17.0, 21.0, 26.0, 29.0, 33.0, 37.0, 42.0],
};
...
export function gradeToMarketAav(grade, valueAnchors) {
  ...
  return Math.round(interp(g, FA_GRADE_ANCHORS, valueAnchors) * 100) / 100;
}
