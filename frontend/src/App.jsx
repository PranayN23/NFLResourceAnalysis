...
import DefenseAnalyst from './pages/DefenseAnalyst';
    ...
    <GlobalProvider>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/cb-analyst" element={<DefenseAnalyst position="CB" />} />
          <Route path="/lb-analyst" element={<DefenseAnalyst position="LB" />} />
        </Routes>
      </BrowserRouter>
    </GlobalProvider>
  );
