...
from backend.ML.TE_Pranay_Transformers.Player_Model_TE import PlayerTransformerRegressor
...
class TEModelInference:
    def __init__(self, transformer_path, scaler_path=None, xgb_path=None):
        ...
        from backend.ML.TE_Pranay_Transformers.Player_Model_TE import SEQ_LEN
    ...
    def _prepare_features(self, player_history):
        ...
        numeric_cols = [
            "grades_offense", "grades_pass_route", "grades_pass_block",
            "grades_hands_drop", "avg_depth_of_target", "caught_percent",
            "drop_rate", "yards", "yards_after_catch", "yards_per_reception",
            "yprr", "receptions", "targets", "touchdowns", "first_downs",
        ...
        xgb_input = {
            ...
            "lag_inline_share":           float(row_last["inline_share"]),
            "lag_block_share":            float(row_last["block_share"]),
    ...
    def get_age_decay_factor(self, age):
        if age <= 30:
            ...
            base = (34 - 30) * 0.8
            additional = (age - 34) * 1.5
            return min(base + additional, 10.0)
