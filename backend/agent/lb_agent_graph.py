...
from backend.agent.stat_projection_utils import defense_snap_load_17, inactivity_retirement_penalty, apply_inactivity_to_projection_list, apply_projection_plausibility_caps
import pandas as pd
import numpy as np
import os, datetime
...
_VALUE_ANCHORS = [0.75, 2.00, 3.50, 6.50, 9.50, 12.5, 16.0, 20.0, 22.5, 25.5, 28.0, 30.0]
