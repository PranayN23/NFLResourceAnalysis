...
# I/O PATHS
# ==========================
DATA_PATH  = os.path.join(os.path.dirname(__file__), "../TightEnds/TE.csv")
...
if __name__ == "__main__":
    print("\nStarting TE Transformer training...")
    ...
    # Filter: minimum 150 routes to qualify as receiving TE
