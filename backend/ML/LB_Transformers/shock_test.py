...
def run_shock_test():
    ...
    print("==== LB MODEL SHOCK TEST: RAW VS AGE-CALIBRATED ====")
    ...
    for year in shock_years:
        ...
        print(f"  Total LBs evaluated : {len(y_true)}")
    ...
    print("Age calibration reduces over-retention of declining elite LBs (30+).")
