...
if __name__ == "__main__":
    # 5. Data Processing
    data_path = 'backend/ML/QB.csv'  # Update path as needed
    ...
    # E.g., use 2020-2022 grades_offense to predict 2023 grades_offense
    features = [
    ...
    SCALER_OUT = 'player_scaler.joblib'
    MODEL_OUT  = 'best_classifier.pth'
