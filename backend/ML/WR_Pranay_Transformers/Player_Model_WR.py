...
# I/O PATHS
# ==========================
DATA_PATH  = os.path.join(os.path.dirname(__file__), "../WR.csv")
...
def make_weighted_sampler(y_train):
    """Oversample elite and poor WRs to combat regression-to-mean bias."""
    ...
    # Boost elite and poor buckets
    bucket_weights[0] *= 1.5   # Very low grades
    bucket_weights[4] *= 1.8   # Elite grades
...
if __name__ == "__main__":
    print("\nStarting WR Transformer training...")
    ...
    # Filter: minimum 200 routes to qualify
